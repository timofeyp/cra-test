...
import { toggleShowCreateModal } from 'store/ducks/settings.duck';
import { pushNewEventRoutine } from 'store/ducks/schedule.duck';
import { toggleShowAlert } from 'store/ducks/alert.duck';
